...
fetch('https://raw.githubusercontent.com/freeCodeCamp/ProjectReferenceData/master/cyclist-data.json')
     ...
     .then(res=> {
        ...
        createStuff(res.map( r=> [convertMinAndSec(r.Time),r.Year,r.Doping,r.Name]));
     });
    ...
    const xScale=d3.scaleTime()
     ...
     .attr('fill',d=>d[2]==='' ? ' rgb(219, 118, 160)' :'rgb(255, 0, 106)')
     .attr('stroke','black')
     .attr('r', radius)
     .on('mouseover', (d, i) => {
       ...
       tooltip.innerHTML = createForToolTip(d);
   }).on('mouseout', () => {
